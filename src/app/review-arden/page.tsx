...
// TODO: Replace with the real Google review link for the Arden Way location.
const REVIEW_URL_ARDEN = 'https://search.google.com/local/writereview?placeid=REPLACE_WITH_ARDEN_PLACE_ID';

export default function ReviewArdenPage() {
  useEffect(() => {
    // Immediately send the visitor to the Google review page.
    window.location.replace(REVIEW_URL_ARDEN);
  }, []);
  ...
  return (
    ...
    >
      ...
      <p className="font-body mb-8" style={{ fontSize: 16, color: '#9E9E9E', maxWidth: 460 }}>
        Redirecting you to Google to review our Arden Way location. If nothing happens,
        tap the button below.
      </p>
      <a
        href={REVIEW_URL_ARDEN}
